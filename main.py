...
### ----------------------benchpress----------------------
# os.system("python train.py --GT_class 0 --F_type 2D --sport benchpress --data BPdata_Final")
# os.system("python train.py --GT_class 1 --F_type 2D --sport benchpress --data BPdata_Final")
# os.system("python train.py --GT_class 2 --F_type 2D --sport benchpress --data BPdata_Final")
# os.system("python train.py --GT_class 3 --F_type 2D --sport benchpress --data BPdata_Final")
# os.system("python train.py --GT_class 4 --F_type 2D --sport benchpress --data BPdata_Final")

# os.system("python train.py --GT_class 0 --F_type 2D --sport benchpress --data BPdata_Final --model BiLSTM")
# os.system("python train.py --GT_class 1 --F_type 2D --sport benchpress --data BPdata_Final --model BiLSTM")
# os.system("python train.py --GT_class 2 --F_type 2D --sport benchpress --data BPdata_Final --model BiLSTM")
os.system("python train.py --GT_class 3 --F_type 2D --sport benchpress --data BPdata_Final --model BiLSTM")
os.system("python train.py --GT_class 4 --F_type 2D --sport benchpress --data BPdata_Final --model BiLSTM")

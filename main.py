...
### ----------------------benchpress----------------------
# os.system("python train.py --GT_class 0 --model BiLSTM --data BP_data_new_angle")
# os.system("python train.py --GT_class 1 --model BiLSTM --data BP_data_new_angle")
# os.system("python train.py --GT_class 2 --model BiLSTM --data BP_data_new_angle")
# os.system("python train.py --GT_class 3 --model BiLSTM --data BP_data_new_angle")
os.system("python train.py --GT_class 4 --model BiLSTM --data BP_data_new_angle")

# os.system("python train.py --GT_class 0 --model Resnet32 --data BP_data_new_angle")
# os.system("python train.py --GT_class 1 --model Resnet32 --data BP_data_new_angle")
# os.system("python train.py --GT_class 2 --model Resnet32 --data BP_data_new_angle")
# os.system("python train.py --GT_class 3 --model Resnet32 --data BP_data_new_angle")
os.system("python train.py --GT_class 4 --model Resnet32 --data BP_data_new_angle")
